...
public class LineIndicator : MonoSingleton<LineIndicator>
{
    ...
    public int[] GetHorizontalLine(int square_index)
    {
        ...
        for(int i = 0; i < 9; i++)
        {
            line[i] = line_data[square_position_row, i];
        }
    ...
    public int[] GetVerticalLine(int square_index)
    {
        ...
        for(int i = 0; i < 9; i++)
        {
            line[i] = line_data[i, square_position_column];
        }
    ...
    public int[] GetAllSquareIndexers()
    {
